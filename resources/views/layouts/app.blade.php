...
<body class="font-sans antialiased text-gray-900">
    ...
    {{-- Header / Navigation Bar (Universal) --}}
    <nav x-data="{ open: false }" class="bg-white shadow-sm border-b border-gray-100">
                ...
                <div class="flex">
                    <div class="shrink-0 flex items-center">
                        <a href="{{ url('/') }}"
                            ...
                            <i class="fas fa-newspaper mr-3 text-3xl"></i> {{ config('app.name', 'Artikel Website') }}
                        </a>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <x-nav-link :href="route('articles.category', 'teknologi')" :active="request()->routeIs('articles.category') &&
                            request()->route('category') == 'teknologi'">
                            {{ __('Kategori') }}
                        </x-nav-link>
                        ...
                        @auth
                            {{-- Anda bisa menambahkan link Kelola Artikel di sini atau di dashboard --}}
                            {{-- <x-nav-link :href="route('articles.index')" :active="request()->routeIs('articles.index')">
                                <i class="fas fa-book-open mr-2"></i> {{ __('Kelola Artikel') }}
                            </x-nav-link> --}}
                        @endauth
                    </div>
                </div>
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('profile.edit')">
                                    <i class="fas fa-id-card mr-2 text-gray-500"></i> {{ __('Profil') }}
                                </x-dropdown-link>
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('articles.category', 'teknologi')" :active="request()->routeIs('articles.category') && request()->route('category') == 'teknologi'">
                    {{ __('Kategori') }}
                </x-responsive-nav-link>
    ...
    {{-- Page Heading (Optional, jika ingin ada judul halaman di bawah navbar) --}}
    {{-- Ini digunakan oleh layout Breeze sebelumnya, Anda bisa menyisipkannya jika halaman memiliki header spesifik --}}
    @if (isset($header))
    ...
    <footer class="bg-gray-800 text-white py-8 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="mt-4 text-sm text-gray-400">
                <a href="#" class="hover:underline mx-2">Kebijakan Privasi</a> |
                <a href="#" class="hover:underline mx-2">Syarat Penggunaan</a>
            </div>
        </div>
    </footer>
</body>

<section class="space-y-6">
    ...
    <x-danger-button x-data="" x-on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion')"
        class="bg-red-600 hover:bg-red-700 py-2 px-4 rounded-md">{{ __('Hapus Akun') }}</x-danger-button>
        ...
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                ...
                <x-text-input id="password" name="password" type="password"
                    class="mt-1 block w-3/4 rounded-lg px-4 py-2" placeholder="{{ __('Password') }}" />
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-danger-button class="ms-3 bg-red-600 hover:bg-red-700 py-2 px-4 rounded-md">
                    {{ __('Hapus Akun') }}
                </x-danger-button>
            </div>
        </form>
